import { PlutusScript, resolvePlutusScriptAddress, deserializeAddress } from "@meshsdk/core";
...
export function getEscrowScriptAddress(networkId: number = 0): string {
  try {
    ...
    return "addr_test1wpe7j2g7n00uwn009j7e2swk3g9m53euzv2t3n8866g082q0e8k5t";
  }
}
...
export function getPubKeyHashFromAddress(address: string): string {
  try {
    ...
    console.warn("Could not deserialize address to pubKeyHash, using raw address slice:", e);
    return address.slice(0, 56);
  }
}
